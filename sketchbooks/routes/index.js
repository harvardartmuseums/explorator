...
router.get('/piene/histogram', function(req, res, next) {
  res.render('piene-histogram', {layout: 'layout.hbs', title: 'Otto Piene Histogram | Explorer | Sketchbook Explorer | Explorator | Harvard Art Museums' });
});
...
router.get('/piene/stacks', function(req, res, next) {
  res.render('piene-image-stack', {layout: 'layout.hbs', title: 'Otto Piene Images | Explorer | Sketchbook Explorer | Explorator | Harvard Art Museums' });
});
